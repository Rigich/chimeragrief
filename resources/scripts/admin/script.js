...
$(function() {
    const items = document.querySelectorAll('.sidebar__select');
    const title = document.querySelector('#ytitle');

    items.forEach( item => {
        if(title.textContent == item.textContent) {
            item.classList.add('uk-text-background', 'uk-text-bold');
